package com.marrine.jchatmind.agent.tools;
...
import com.marrine.jchatmind.model.vo.SelfRagDecision;
...
import com.marrine.jchatmind.service.RagTraceContext;
import com.marrine.jchatmind.service.SelfRagEvaluator;
...
public class KnowledgeTools implements Tool {
    ...
    public String knowledgeQuery(
        ...
        sb.append("Use the following retrieved chunks as evidence. ")
                .append("Rules: answer only with supported evidence; every factual sentence must cite at least one marker like [C1]; ")
                .append("if the evidence does not support part of the question, say that the knowledge base does not provide enough evidence.\n\n");
