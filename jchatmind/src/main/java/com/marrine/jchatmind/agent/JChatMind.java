...
import com.marrine.jchatmind.message.SseMessage;
...
public class JChatMind {
    ...
    private boolean think() {
        String thinkToolRules = """
                ...
                + "\nIf KnowledgeTool returns chunks marked [C1], [C2], etc., answer only from those chunks. "
                + "Every factual sentence that uses retrieved knowledge must end with the relevant marker. "
                + "If the chunks do not support the answer, say the knowledge base evidence is insufficient.\n";
